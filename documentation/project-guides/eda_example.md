...
```python
# read in dataset
df = pd.read_csv('/content/drive/MyDrive/eda/311-requests.csv') 
```
...
```
  ...
  <div id="df-867fc3a9-6dce-4dad-83fe-e52fc1e20715">
...
<p>5 rows × 29 columns</p>
      ...
      <button class="colab-df-convert" onclick="convertToInteractive('df-867fc3a9-6dce-4dad-83fe-e52fc1e20715')"
  ...
  <style>
    ...
    [theme=dark] .colab-df-convert:hover {
      ...
      <script>
        const buttonEl =
          document.querySelector('#df-867fc3a9-6dce-4dad-83fe-e52fc1e20715 button.colab-df-convert');
        buttonEl.style.display =
          google.colab.kernel.accessAllowed ? 'block' : 'none';

        async function convertToInteractive(key) {
          const element = document.querySelector('#df-867fc3a9-6dce-4dad-83fe-e52fc1e20715');
          const dataTable =
