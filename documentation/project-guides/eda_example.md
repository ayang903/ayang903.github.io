...
```
    ...
    "|    |   case_enquiry_id | open_dt             | target_dt           | closed_dt           | ontime   | case_status   | closure_reason                                                         | case_title                                | subject                           | reason                           | type                                     | queue                    | department   | submittedphoto                                                                                       |   closedphoto | location                                              | fire_district   | pwd_district   | city_council_district   | police_district   | neighborhood                           | neighborhood_services_district   | ward    | precinct   | location_street_name                   |   location_zipcode |   latitude |   longitude | source               |\n|---:|------------------:|:--------------------|:--------------------|:--------------------|:---------|:--------------|:-----------------------------------------------------------------------|:------------------------------------------|:----------------------------------|:---------------------------------|:-----------------------------------------|:-------------------------|:-------------|:-----------------------------------------------------------------------------------------------------|--------------:|:------------------------------------------------------|:----------------|:---------------|:------------------------|:------------------|:---------------------------------------|:---------------------------------|:--------|:-----------|:---------------------------------------|-------------------:|-----------:|------------:|:---------------------|\n|  0 |      101004125189 | 2022-01-13 12:59:00 | 2022-01-20 12:59:39 | nan                 | OVERDUE  | Open          |                                                                        | Illegal Rooming House                     | Inspectional Services             | Building                         | Illegal Rooming House                    | ISD_Housing (INTERNAL)   | ISD          | nan                                                                                                  |           nan | 27 Lithgow St  Dorchester  MA  02124                  | 8               | 07             | 4                       | C11               | Dorchester                             | 8                                | Ward 17 | 1706       | 27 Lithgow St                          |               2124 |    42.2896 |    -71.0701 | Constituent Call     |\n|  1 |      101004161747 | 2022-02-02 11:42:49 | 2022-02-16 11:42:49 | 2022-02-02 11:45:47 | ONTIME   | Closed        | Case Closed Case Noted                                                 | PublicWorks: Complaint                    | Mayor's 24 Hour Hotline           | Employee & General Comments      | General Comments For a Program or Policy | PWDx_General Comments    | PWDx         | nan                                                                                                  |           nan |                                                       |                 |                |                         |                   |                                        |                                  |         |            | nan                                    |                nan |    42.3594 |    -71.0587 | Constituent Call     |\n|  2 |      101004149944 | 2022-01-28 19:36:00 | nan                 | nan                 | ONTIME   | Open          |                                                                        | Space Savers                              | Public Works Department           | Sanitation                       | Space Savers                             | PWDx_Space Saver Removal | PWDx         | nan                                                                                                  |           nan | 492 Harvard St  Dorchester  MA  02124                 | 8               | 07             | 4                       | B3                | Greater Mattapan                       | 9                                | Ward 14 | 1411       | 492 Harvard St                         |               2124 |    42.2876 |    -71.0936 | Constituent Call     |\n|  3 |      101004113302 | 2022-01-01 00:36:24 | 2022-01-04 08:30:00 | 2022-01-03 00:13:17 | ONTIME   | Closed        | Case Closed. Closed date : 2022-01-03 00:13:17.393 Case Resolved CLEAR | Parking Enforcement                       | Transportation - Traffic Division | Enforcement & Abandoned Vehicles | Parking Enforcement                      | BTDT_Parking Enforcement | BTDT         | https://311.boston.gov/media/boston/report/photos/61cfe84b05bbcf180c293ece/photo_20220101_003547.jpg |           nan | INTERSECTION of Seaport Blvd & Sleeper St  Boston  MA | 6               | 05             | 2                       | C6                | South Boston / South Boston Waterfront | 5                                | 6       | 0601       | INTERSECTION Seaport Blvd & Sleeper St |                nan |    42.3594 |    -71.0587 | Citizens Connect App |\n|  4 |      101004122704 | 2022-01-11 09:47:00 | 2022-02-10 09:47:22 | nan                 | OVERDUE  | Open          |                                                                        | DISPATCHED Heat - Excessive  Insufficient | Inspectional Services             | Housing                          | Heat - Excessive  Insufficient           | ISD_Housing (INTERNAL)   | ISD          | nan                                                                                                  |           nan | 15 Crawford St  Dorchester  MA  02121                 | 9               | 10B            | 7                       | B2                | Roxbury                                | 13                               | Ward 12 | 1202       | 15 Crawford St                         |               2121 |    42.311  |    -71.0841 | Constituent Call     |"
...
```
  ...
  <div id="df-f43158e4-a5b5-483b-9f65-9b6774a2a8da">
...
<p>5 rows × 29 columns</p>
      ...
      <button class="colab-df-convert" onclick="convertToInteractive('df-f43158e4-a5b5-483b-9f65-9b6774a2a8da')"
  ...
  <style>
    ...
    [theme=dark] .colab-df-convert:hover {
      ...
      <script>
        const buttonEl =
          document.querySelector('#df-f43158e4-a5b5-483b-9f65-9b6774a2a8da button.colab-df-convert');
        buttonEl.style.display =
          google.colab.kernel.accessAllowed ? 'block' : 'none';

        async function convertToInteractive(key) {
          const element = document.querySelector('#df-f43158e4-a5b5-483b-9f65-9b6774a2a8da');
          const dataTable =
...
```
  ...
  <div id="df-58610b27-8de4-4344-9e0a-916c81aa15b0">
    <div class="colab-df-container">
      <div>
<style scoped>
    .dataframe tbody tr th:only-of-type {
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      ...
      <button class="colab-df-convert" onclick="convertToInteractive('df-58610b27-8de4-4344-9e0a-916c81aa15b0')"
              title="Convert this dataframe to an interactive table."
              style="display:none;">
  ...
  <style>
    ...
    [theme=dark] .colab-df-convert:hover {
      ...
      <script>
        const buttonEl =
          document.querySelector('#df-58610b27-8de4-4344-9e0a-916c81aa15b0 button.colab-df-convert');
        buttonEl.style.display =
          google.colab.kernel.accessAllowed ? 'block' : 'none';

        async function convertToInteractive(key) {
          const element = document.querySelector('#df-58610b27-8de4-4344-9e0a-916c81aa15b0');
          const dataTable =
            await google.colab.kernel.invokeFunction('convertToInteractive',
                                                     [key], {});
          if (!dataTable) return;
...
```
  ...
  <div id="df-ca6a9bc4-90d8-479d-9b1b-306ca23a543b">
    <div class="colab-df-container">
      <div>
<style scoped>
    .dataframe tbody tr th:only-of-type {
...
<p>5 rows × 29 columns</p>
      ...
      <button class="colab-df-convert" onclick="convertToInteractive('df-ca6a9bc4-90d8-479d-9b1b-306ca23a543b')"
              title="Convert this dataframe to an interactive table."
              style="display:none;">
  ...
  <style>
    ...
    [theme=dark] .colab-df-convert:hover {
      ...
      <script>
        const buttonEl =
          document.querySelector('#df-ca6a9bc4-90d8-479d-9b1b-306ca23a543b button.colab-df-convert');
        buttonEl.style.display =
          google.colab.kernel.accessAllowed ? 'block' : 'none';

        async function convertToInteractive(key) {
          const element = document.querySelector('#df-ca6a9bc4-90d8-479d-9b1b-306ca23a543b');
          const dataTable =
            await google.colab.kernel.invokeFunction('convertToInteractive',
                                                     [key], {});
          if (!dataTable) return;
...
```
  ...
  <div id="df-92f160b7-fa4f-491d-bc99-6847ea0e5f89">
    <div class="colab-df-container">
      <div>
<style scoped>
    .dataframe tbody tr th:only-of-type {
...
<p>5 rows × 29 columns</p>
      ...
      <button class="colab-df-convert" onclick="convertToInteractive('df-92f160b7-fa4f-491d-bc99-6847ea0e5f89')"
              title="Convert this dataframe to an interactive table."
              style="display:none;">
  ...
  <style>
    ...
    [theme=dark] .colab-df-convert:hover {
      ...
      <script>
        const buttonEl =
          document.querySelector('#df-92f160b7-fa4f-491d-bc99-6847ea0e5f89 button.colab-df-convert');
        buttonEl.style.display =
          google.colab.kernel.accessAllowed ? 'block' : 'none';

        async function convertToInteractive(key) {
          const element = document.querySelector('#df-92f160b7-fa4f-491d-bc99-6847ea0e5f89');
          const dataTable =
            await google.colab.kernel.invokeFunction('convertToInteractive',
                                                     [key], {});
          if (!dataTable) return;
...
```
  ...
  <div id="df-bf220ce3-8ff7-40f4-aba1-5577ac420a69">
    <div class="colab-df-container">
      <div>
<style scoped>
    .dataframe tbody tr th:only-of-type {
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      ...
      <button class="colab-df-convert" onclick="convertToInteractive('df-bf220ce3-8ff7-40f4-aba1-5577ac420a69')"
              title="Convert this dataframe to an interactive table."
              style="display:none;">
  ...
  <style>
    ...
    [theme=dark] .colab-df-convert:hover {
      ...
      <script>
        const buttonEl =
          document.querySelector('#df-bf220ce3-8ff7-40f4-aba1-5577ac420a69 button.colab-df-convert');
        buttonEl.style.display =
          google.colab.kernel.accessAllowed ? 'block' : 'none';

        async function convertToInteractive(key) {
          const element = document.querySelector('#df-bf220ce3-8ff7-40f4-aba1-5577ac420a69');
          const dataTable =
            await google.colab.kernel.invokeFunction('convertToInteractive',
                                                     [key], {});
          if (!dataTable) return;
...
```
  ...
  <div id="df-bcb14cca-0abe-4022-a8a2-2f8823985b53">
    <div class="colab-df-container">
      <div>
<style scoped>
    .dataframe tbody tr th:only-of-type {
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      ...
      <button class="colab-df-convert" onclick="convertToInteractive('df-bcb14cca-0abe-4022-a8a2-2f8823985b53')"
              title="Convert this dataframe to an interactive table."
              style="display:none;">
  ...
  <style>
    ...
    [theme=dark] .colab-df-convert:hover {
      ...
      <script>
        const buttonEl =
          document.querySelector('#df-bcb14cca-0abe-4022-a8a2-2f8823985b53 button.colab-df-convert');
        buttonEl.style.display =
          google.colab.kernel.accessAllowed ? 'block' : 'none';

        async function convertToInteractive(key) {
          const element = document.querySelector('#df-bcb14cca-0abe-4022-a8a2-2f8823985b53');
          const dataTable =
            await google.colab.kernel.invokeFunction('convertToInteractive',
                                                     [key], {});
          if (!dataTable) return;
...
```
    ...
    <seaborn.axisgrid.FacetGrid at 0x7f8064f1b450>
...
```
    ...
    <seaborn.axisgrid.FacetGrid at 0x7f8062417c90>
...
```
    ...
    <seaborn.axisgrid.FacetGrid at 0x7f806240eb10>
...
```
    ...
    <seaborn.axisgrid.FacetGrid at 0x7f806228e250>
...
```
  ...
  <div id="df-6917bb97-6215-4bf6-b332-87e3f14de8da">
    <div class="colab-df-container">
      <div>
<style scoped>
    .dataframe tbody tr th:only-of-type {
...
<p>15 rows × 30 columns</p>
      ...
      <button class="colab-df-convert" onclick="convertToInteractive('df-6917bb97-6215-4bf6-b332-87e3f14de8da')"
              title="Convert this dataframe to an interactive table."
              style="display:none;">
  ...
  <style>
    ...
    [theme=dark] .colab-df-convert:hover {
      ...
      <script>
        const buttonEl =
          document.querySelector('#df-6917bb97-6215-4bf6-b332-87e3f14de8da button.colab-df-convert');
        buttonEl.style.display =
          google.colab.kernel.accessAllowed ? 'block' : 'none';

        async function convertToInteractive(key) {
          const element = document.querySelector('#df-6917bb97-6215-4bf6-b332-87e3f14de8da');
          const dataTable =
            await google.colab.kernel.invokeFunction('convertToInteractive',
                                                     [key], {});
          if (!dataTable) return;
...
```
  ...
  <div id="df-7a7435af-a0fe-4fb4-84f9-211b0c3dd0a8">
    <div class="colab-df-container">
      <div>
<style scoped>
    .dataframe tbody tr th:only-of-type {
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      ...
      <button class="colab-df-convert" onclick="convertToInteractive('df-7a7435af-a0fe-4fb4-84f9-211b0c3dd0a8')"
              title="Convert this dataframe to an interactive table."
              style="display:none;">
  ...
  <style>
    ...
    [theme=dark] .colab-df-convert:hover {
      ...
      <script>
        const buttonEl =
          document.querySelector('#df-7a7435af-a0fe-4fb4-84f9-211b0c3dd0a8 button.colab-df-convert');
        buttonEl.style.display =
          google.colab.kernel.accessAllowed ? 'block' : 'none';

        async function convertToInteractive(key) {
          const element = document.querySelector('#df-7a7435af-a0fe-4fb4-84f9-211b0c3dd0a8');
          const dataTable =
            await google.colab.kernel.invokeFunction('convertToInteractive',
                                                     [key], {});
          if (!dataTable) return;
...
```
  ...
  <div id="df-2f5e6605-27cc-4b9a-992e-0841db8baade">
    <div class="colab-df-container">
      <div>
<style scoped>
    .dataframe tbody tr th:only-of-type {
...
<p>594 rows × 1 columns</p>
      ...
      <button class="colab-df-convert" onclick="convertToInteractive('df-2f5e6605-27cc-4b9a-992e-0841db8baade')"
              title="Convert this dataframe to an interactive table."
              style="display:none;">
  ...
  <style>
    ...
    [theme=dark] .colab-df-convert:hover {
      ...
      <script>
        const buttonEl =
          document.querySelector('#df-2f5e6605-27cc-4b9a-992e-0841db8baade button.colab-df-convert');
        buttonEl.style.display =
          google.colab.kernel.accessAllowed ? 'block' : 'none';

        async function convertToInteractive(key) {
          const element = document.querySelector('#df-2f5e6605-27cc-4b9a-992e-0841db8baade');
          const dataTable =
            await google.colab.kernel.invokeFunction('convertToInteractive',
                                                     [key], {});
          if (!dataTable) return;
...
```
  ...
  <div id="df-f0243a94-3b6a-43a6-84d4-6e63ad8e8bed">
    <div class="colab-df-container">
      <div>
<style scoped>
    .dataframe tbody tr th:only-of-type {
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      ...
      <button class="colab-df-convert" onclick="convertToInteractive('df-f0243a94-3b6a-43a6-84d4-6e63ad8e8bed')"
              title="Convert this dataframe to an interactive table."
              style="display:none;">
  ...
  <style>
    ...
    [theme=dark] .colab-df-convert:hover {
      ...
      <script>
        const buttonEl =
          document.querySelector('#df-f0243a94-3b6a-43a6-84d4-6e63ad8e8bed button.colab-df-convert');
        buttonEl.style.display =
          google.colab.kernel.accessAllowed ? 'block' : 'none';

        async function convertToInteractive(key) {
          const element = document.querySelector('#df-f0243a94-3b6a-43a6-84d4-6e63ad8e8bed');
          const dataTable =
            await google.colab.kernel.invokeFunction('convertToInteractive',
                                                     [key], {});
          if (!dataTable) return;
...
```
    ...
    <seaborn.axisgrid.FacetGrid at 0x7f80618b2850>
...
```
    ...
    <seaborn.axisgrid.FacetGrid at 0x7f8061905710>
...
```
  ...
  <div id="df-82b8e896-ff51-47d2-82a2-2d3e7f06381c">
    <div class="colab-df-container">
      <div>
<style scoped>
    .dataframe tbody tr th:only-of-type {
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      ...
      <button class="colab-df-convert" onclick="convertToInteractive('df-82b8e896-ff51-47d2-82a2-2d3e7f06381c')"
              title="Convert this dataframe to an interactive table."
              style="display:none;">
  ...
  <style>
    ...
    [theme=dark] .colab-df-convert:hover {
      ...
      <script>
        const buttonEl =
          document.querySelector('#df-82b8e896-ff51-47d2-82a2-2d3e7f06381c button.colab-df-convert');
        buttonEl.style.display =
          google.colab.kernel.accessAllowed ? 'block' : 'none';

        async function convertToInteractive(key) {
          const element = document.querySelector('#df-82b8e896-ff51-47d2-82a2-2d3e7f06381c');
          const dataTable =
            await google.colab.kernel.invokeFunction('convertToInteractive',
                                                     [key], {});
          if (!dataTable) return;
...
```
    ...
    <seaborn.axisgrid.FacetGrid at 0x7f806176d710>
...
```
  ...
  <div id="df-318d9879-bf74-40b9-ae07-f4af5184ea2c">
    <div class="colab-df-container">
      <div>
<style scoped>
    .dataframe tbody tr th:only-of-type {
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      ...
      <button class="colab-df-convert" onclick="convertToInteractive('df-318d9879-bf74-40b9-ae07-f4af5184ea2c')"
              title="Convert this dataframe to an interactive table."
              style="display:none;">
  ...
  <style>
    ...
    [theme=dark] .colab-df-convert:hover {
      ...
      <script>
        const buttonEl =
          document.querySelector('#df-318d9879-bf74-40b9-ae07-f4af5184ea2c button.colab-df-convert');
        buttonEl.style.display =
          google.colab.kernel.accessAllowed ? 'block' : 'none';

        async function convertToInteractive(key) {
          const element = document.querySelector('#df-318d9879-bf74-40b9-ae07-f4af5184ea2c');
          const dataTable =
            await google.colab.kernel.invokeFunction('convertToInteractive',
                                                     [key], {});
          if (!dataTable) return;
